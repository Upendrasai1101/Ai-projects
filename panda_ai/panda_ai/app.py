# --- FILE: app.py --- V5 Real-Time Persona Build
"""
Panda AI V5 — Real-Time Persona Build
Core Identity: AI lives in April 2026. No cutoff dates. No 'I don't have real-time access'.
- LIVE SEARCH context = AI's own current knowledge
- Snippets treated as first-hand information, not 'search results being read'
- Universal: politics, sports, greetings, general knowledge — all handled in-character
...
# ════════════════════════════════════════════════════════════════
# SYSTEM PROMPT — April 2026 Confident Real-Time Persona
#
# Core design decisions:
# 1. AI self-identifies as living in April 2026 — no cutoff framing
...
def build_system_prompt(dc, memory_ctx, has_search, search_attempted):
    ...
    identity = (
        ...
        f"You are fully up to date as of {dc['date']}.\n"
        f"You have complete awareness of current events, news, sports, politics, and more.\n\n"
        ...
        "INSTEAD, you speak with confidence:\n"
        "  ✅ 'As of today, X is Y.'\n"
        "  ✅ 'The current [role] is X.'\n"
...
def health():
    ...
    return jsonify({
        ...
        "mode":        "April 2026 Real-Time Persona",
    }), 200
...
if __name__ == "__main__":
    ...
    print(f"   Identity: April 2026 | Temp: 0.4 | Memory: {len(load_memory())} keys")
    print(f"   No cutoff phrases | Live search = AI's own knowledge")
