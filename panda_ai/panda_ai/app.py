...
def build_system_prompt(dc, memory_ctx, has_search, search_attempted):
    ...
    live_context_rules = (
        "\n\n━━━ LIVE CONTEXT PRIORITY RULE ━━━\n"
        "For all real-time topics, especially news, sports, leaders, entertainment, tech, and weather, "
        "you MUST prioritize the provided search context over your internal memory.\n"
        "If the search context contains fresh facts, treat them as the authoritative current answer.\n"
        "Do not let older memory or general knowledge override the live search context for these topics."
    )
    identity = identity + live_context_rules
    widget_instructions = (
    )
    widget_instructions = (
        "\n\nWIDGET INSTRUCTIONS:\n"
